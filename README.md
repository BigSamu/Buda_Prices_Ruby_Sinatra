...
A simple Ruby Sinatra web application that fetch data from [Buda API](https://api.buda.com/en/), an online Chilean cryptocurrency exchange market.
...
> **NOTE:** at the momment of the implentation of this project `Ruby v3.1.3`, `RubyGems v3.4.6` and `bundler v2.3.26` were used. `RubyGems` comes already included in `Ruby 3`. No need for a separate installation of it.
